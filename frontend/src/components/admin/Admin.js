...
class Admin extends Component {
  ...
  render() {
    ...
    var clinicHead = null;
    if (showClinic) {
      clinicHead = <h6>Add Clinic Details</h6>;
      clinicForm = (
        <div>
          <Col>
            ...
            <Row>
              <h6>
                Name of the Clinic<span style={{ color: "red" }}>*</span>
              </h6>
            </Row>
            <span style={{ color: "red" }}></span>
            <Row>
            ...
            <Row>
              ...
              <Col>
                <Row>
                  <h6>
                    Number Of Physicians<span style={{ color: "red" }}>*</span>
                  </h6>
                </Row>
                <span style={{ color: "red" }}> </span>
    ...
    if (showDisease) {
      clinicHead = <h6>Add Disease Details</h6>;
      clinicForm = (
        <div>
          <Col>
            <span style={{ color: "red" }}>* </span>{" "}
    ...
    if (showVaccine) {
      clinicHead = <h6>Add Vaccine Details</h6>;
      clinicForm = (
        <div>
          <Col>
            <span style={{ color: "red" }}>* </span>{" "}
            ...
            <Row>
              <h6>
                Name of the Vaccine<span style={{ color: "red" }}>*</span>
              </h6>
            </Row>
            <span style={{ color: "red" }}></span>
            <Row>
            ...
            <Row>
              <Col>
                <Row>
                  <h6>
                    Diseases<span style={{ color: "red" }}></span>
                  </h6>
                </Row>
            ...
            <Row>
              ...
              <Col>
                <Row>
                  <h6>
                    No. of Shots<span style={{ color: "red" }}>*</span>
                  </h6>
                </Row>
                <span style={{ color: "red" }}></span>
    ...
    return (
      <div class="">
        <div className="container1">
          <Button className="adminbtns" onClick={this.addClinicModal}>
            Add Clinic
          </Button>
          <Button className="adminbtns" onClick={this.addDiseaseModal}>
            Add Disease
          </Button>
          <Button className="adminbtns" onClick={this.addVaccineModal}>
            Add Vaccine
          </Button>
          <br />
          <Button className="adminbtns" onClick={this.showAllClinics}>
            All Clinics
          </Button>
          <Button className="adminbtns" onClick={this.showAllDiseases}>
            All Diseases
          </Button>
          <Button className="adminbtns" onClick={this.showAllVacinations}>
            All Vaccines
          </Button>
        </div>
        <div>
          ...
          >
            ...
            <Modal.Body>{clinicForm}</Modal.Body>
          </Modal>
        </div>
      </div>
    );
